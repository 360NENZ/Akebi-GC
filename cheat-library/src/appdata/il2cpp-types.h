...
namespace app {
    ...
    struct __declspec(align(8)) BaseEntity__Fields {
        struct Dictionary_2_System_UInt32_MoleMole_AIPerceptionInfo_* _aiPerceptionDic;
        struct MoleMole_Config_ConfigEntity* jsonConfig;
        struct MoleMole_Config_EntityExcelConfig* excelConfig;
        ...
        bool _isInited;
        struct Action_1_MoleMole_EvtEntityTimeScaleChange_* _onLevelTimeScaleChange;
        struct Action* _syncAnimatorSpeed;
        struct Action* _onTimeScaleChangedByAbility;
        struct MoleMole_EntityQueryIndex* _queryIndex;
        struct MoleMole_AbilityComponentProxy* _abilityProxy;
        ...
        float HLJJGAOMCGC;
        bool _isEntityReady;
        struct Action_1_MoleMole_BaseEntity_* onComponentInitPostCallback;
        struct Action_1_MoleMole_BaseEntity_* onEntityReadyPreCallback;
        struct Action_1_MoleMole_BaseEntity_* onEntityReadyBeforePostCallback;
        bool _IsTickable;
        ...
        bool _isDestroying;
        struct Action_1_MoleMole_BaseEntity_* onEntityRemovedCallback;
        struct Action_1_MoleMole_BaseEntity_* onDestroyCallback;
        bool _isAlive;
        struct Action_1_MoleMole_BaseEntity_* onSetAliveFalseCallback;
        bool _isActive;
        struct Action_1_MoleMole_BaseEntity_* preAnimatorInitUpdateCallback;
        bool _needSetActiveOnEntityReady;
        bool _setActiveOnEntityReady;
        struct Action_2_MoleMole_BaseEntity_Boolean_* onSetActiveCallback;
        ...
        struct MoleMole_FixedStack_1_System_Single_* _timeScaleStack;
        ...
        struct List_1_MoleMole_BaseEntity_MoleMole_BaseEntity_ComponentInitNotifyData_* _notifyListOnComponentInit;
        struct Dictionary_2_System_String_MoleMole_DynamicCollisionInfo_* _collisionTagDic;
        bool _needSafeEntityInit;
        struct List_1_MoleMole_EntitySafeCmd_* _entitySafeCmds;
        struct Vector3 _sharedPosition;
        struct Vector3 _sharedForward;
        struct MoleMole_MEventDispatcher* _eventDispatcher;
        ...
        struct HashSet_1_MoleMole_IRequestOwnerEntityNoPauseTask_* _noPauseTaskRequests;
        bool AHKEFAMPGBJ;
        bool KPEBDCGGBGE;
        TickState__Enum _currentAnimatorTickState;
        struct MoleMole_EntityTickBalanceProxy* _tickBalanceProxy;
        ...
        struct MoleMole_Config_ConfigAnimator* _animatorConfig;
        ...
        struct Dictionary_2_System_String_MoleMole_BaseEntity_MoleMole_BaseEntity_AnimeLoadInfo_* _curLoadedAnime;
        struct MoleMole_RecycledLinkedList_1_MoleMole_BaseEntity_MoleMole_BaseEntity_AnimeLoadInfo_* _needFlushResetAnimes;
        int32_t _curForceCacheFreeStyleId;
        struct MoleMole_EntityTimerReceiver* _animeRecycleTimer;
        struct Coroutine* _checkAnimeLoadFinishCoroutine;
        struct MoleMole_BaseEntity_MoleMole_BaseEntity_AnimeOverrideFlushList* _animatorOverrideFlushList;
        struct MoleMole_EntityPreloader* _onCreatePreloader;
        struct MoleMole_EntityPreloader* _onCombatPreloader;
        struct MoleMole_EntityPreloader* _onSceneDataNotifyPreloader;
        uint32_t _gameObjectResourceHandle;
        int32_t _preloadIndex;
        struct GameObject* _preLoadObject;
        struct Action_1_MoleMole_BaseEntity_* _jsonConfigLoadedCallback;
        ...
        struct MoleMole_MaterialGroup* _defaultGroup;
        struct MoleMole_MaterialGroup* _instancedMaterialGroup;
        ...
        struct Action_1_MoleMole_BaseEntity_* finishLoadCallback;
        ...
        struct MoleMole_WorldTimer* _infoTimer;
        struct MoleMole_EntityGameObjectNode* _gameObjectNode;
        bool _isGameObjectFromPool;
        bool _isEntityAsyncLoad;
        bool _hasGameObject_k__BackingField;
        float _curMass;
        struct MoleMole_FixedFloatStack* _massRatio;
